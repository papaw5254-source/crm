...
const SOURCES: MoneyIncomeSource[] = ['FOUNDER', 'BANK', 'DAILY_SALE', 'DEBT_RETURN', 'END_OF_DAY_BALANCE', 'OTHER']

const schema = z.object({
  amount: z.coerce.number().min(0.01, "Summa 0 dan katta bo'lishi kerak"),
  source: z.enum(['FOUNDER', 'BANK', 'DAILY_SALE', 'DEBT_RETURN', 'END_OF_DAY_BALANCE', 'OTHER']),
